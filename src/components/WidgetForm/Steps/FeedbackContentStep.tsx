import { ArrowLeft, Camera, CaretLeft } from 'phosphor-react'
      ...
      <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
        ...
        <footer className="flex gap-2 mt-2">
          ...
          <button
            ...
            type="submit"
            className="py-2 bg-brand-500 rounded-md border-transparent flex-1 flex items-center justify-center 
